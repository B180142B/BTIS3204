...
$sql1 = "SELECT * FROM post LEFT JOIN student ON post.Student = student.StudentID WHERE PostID = " .$post. " AND Showed = 1;";
...
// Prepare a select statement
$sql = "SELECT * FROM comment WHERE PostID = " .$post. " AND Showed = 1;";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    $sql = "INSERT INTO comment (Comment, PostID, Uploader) VALUES (?, ?, ?);";
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="d-flex justify-content-between align-items-center activity">
                                <div><h1><?php echo $myrow1['Post'];?></h1></div>
                                <div class="d-flex justify-content-between align-items-center activity" style="text-align: right;">
                                    <div><h5 style="color: grey; margin-top: 10px;">By <?php echo $myrow1['Name'];?><br><?php echo $myrow1['DateTime'];?></h5></div>
                                </div>
                            </div>
...
<?php 
// Prepare a select statement
$sql2 = "SELECT * FROM comment LEFT JOIN teacher ON comment.Uploader = teacher.TeacherID WHERE PostID = " .$post. " AND Showed = 1 LIMIT ".$offset.", ".$pagesize.";";
                                        ...
                                        <li class="d-flex justify-content-between">
                                            <div class="d-flex flex-row align-items-center">
                                                <div class="ml-2" style="padding: 20px;">
                                                    <h4 class="mb-0"><?php echo $myrow2['Comment'];?></h4>
                                                </div>
                                            </div>
                                            <div class="d-flex flex-row align-items-center" style="text-align: right;">
                                                <div class="d-flex flex-column mr-2" style="padding: 20px;">
                                                    <h3 class="date-time">By <?php
                                                    if ($myrow2['Name'] != null) {
                                                        echo "Cik. ".$myrow2['Name'];
                                                    } else {
$sql3 = "SELECT * FROM comment LEFT JOIN student ON comment.Uploader = student.StudentID WHERE CommentID = " .$myrow2['CommentID']. " AND Showed = 1;";
$res3 = mysqli_query($conn, $sql3);
$myrow3 = mysqli_fetch_array($res3);

                                                        echo $myrow3['Name'];
                                                    }?><br><?php echo $myrow2['DateTime'];?></h3>
                                                </div>
                                            </div>
                                        </li>
                                    </a>

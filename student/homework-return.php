...
if (isset($_GET['h'])) {
    $homeworkReturnID = $_GET['h'];
} else {
    header("location: homework.php");
}

// Prepare a select statement
$sql = "SELECT * FROM homeworkreturn LEFT JOIN homeworkDone ON homeworkreturn.HomeworkDoneID = homeworkDone.HomeworkDoneID LEFT JOIN homework ON homework.HomeworkID = homeworkdone.Homework WHERE HomeworkReturnID = ".$homeworkReturnID." AND StudentID = ".$id.";";
                        ...
                        <div class="col-md-8">
                            ...
                            <form class="contact-comments m-top-50" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 form-group">
                                        <label for="form-field-name">Returned</label>
                                        <br>

                                        <a href="<?php echo $myrow['HomeworkReturn']; ?>" target="_blank">
<?php if ($myrow['HomeworkReturn'] != null) {?>
                                            <div style="border: 2px solid; border-radius: 12px; padding-left: 15px; margin-bottom: 10px;">
                                                <div style="height: 30px;">
                                                    <h4 class="mb-0"><?php echo basename($myrow['HomeworkReturn']);?></h4>
                                                </div>
                                            </div>
                                        </a>
<?php }?>
<?php if ($myrow['Remark'] != null) {?>
                                        <label for="form-field-name">Remark</label>
                                        <div style="padding-left: 15px; margin-bottom: 10px;">
                                            <div style="height: 30px;">
                                                <h4 class="mb-0"><?php echo basename($myrow['Remark']);?></h4>
                                            </div>
                                        </div>
<?php }?>
                                        
                                        <p>Returned by <?php echo $myrow['DateTime2']; ?></p>
                                    </div>
                                </div>
                            </form>
                        </div>

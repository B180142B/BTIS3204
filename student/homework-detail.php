...
$sql = "SELECT * FROM homeworkdone LEFT JOIN homework ON homeworkdone.Homework = homework.HomeworkID WHERE HomeworkID = ".$homeworkID." AND StudentID = ".$id.";";
                            ...
                            <form class="contact-comments m-top-50" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-md-2 formgroup">
                                        <a href="homework-submit.php?hd=<?php echo $myrow['HomeworkDoneID']; ?>" name="" class="btn" style="border: 2px solid; border-radius: 12px; padding-left: 15px; margin-bottom: 10px;">Resubmit</a>
                                    </div>

    	...
    	<div id="content" class="p-4 p-md-5 pt-5">
    		<div style="text-align: center; margin-top: 100px;">
      			<div class="flex-container">
	      			<a href="user.php"><div class="flex-container2">User Account</div></a>
	      			<a href="announcement.php"><div class="flex-container2">Announcement</div></a>
	      			<a href="class.php"><div class="flex-container2">Student Class</div></a>
	      		</div>
	      		<br>
	      		<div class="flex-container">
	      			<a href="class_teacher.php"><div class="flex-container2">Class Teacher</div></a>
	      			<a href="teacher_forum_list.php"><div class="flex-container2">Teacher Forum</div></a>
	      			<a href="student_forum_list.php"><div class="flex-container2">Student Forum</div></a>
	      		</div>
	      	</div>
	      </div>
	</div>

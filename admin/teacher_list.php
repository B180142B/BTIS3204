...
<?php
// Prepare a select statement
$sql1 = "SELECT * FROM teacher WHERE Activated = 0 AND TeacherID > 1;";

$res1 = mysqli_query($conn, $sql1);

while ($myrow1 = mysqli_fetch_array($res1)) { ?>
						<tr>
							<td><a href="teacher_account.php?t=<?php echo $myrow1['TeacherID'] ?>"><?php echo $myrow1['Name']; ?></a></td>
							<?php
							if ($myrow1['Activated']  == 1) { ?>

...
// Prepare a select statement
$sql1 = "SELECT * FROM student LEFT JOIN class ON student.Class = class.ClassID WHERE StudentID = ".$student.";";
...
if($_SERVER["REQUEST_METHOD"] == "POST") {
	$class = $_POST['class'];
  $sql2 = "UPDATE student SET Class = ".$class." WHERE StudentID = ".$student.";";
      			...
      			<div class="">
      				...
      				<form class="modal-content animate" method="post">
      					...
      					<div class="container">
      						...
      						<select name="class">
<?php
if ($myrow1['Class'] == null) {?>
										<option selected='true'>-</option>
<?php }
$sql3 = "SELECT * FROM class LEFT JOIN teacher ON class.TeacherID = teacher.TeacherID;";

$res3 = mysqli_query($conn, $sql3);

while ($myrow3 = mysqli_fetch_array($res3)) {
	if ($myrow1['Class'] == $myrow3['ClassID']) { ?>
										<option value="<?php echo $myrow3['ClassID']; ?>" selected='true'><?php echo $myrow3['Tingkatan'].$myrow3['ClassName']." - Cik. ".$myrow3['Name']; ?></option>
<?php	} else {?>
      							<option value="<?php echo $myrow3['ClassID']; ?>"><?php echo $myrow3['Tingkatan'].$myrow3['ClassName']." - Cik. ".$myrow3['Name']; ?></option>
<?php }}?>
      						</select>

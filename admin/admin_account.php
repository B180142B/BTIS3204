...
// Prepare a select statement
$sql1 = "SELECT * FROM admin WHERE AdminID = ".$admin.";";
...
if($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$sql2 = "SELECT * FROM admin WHERE Username = \"".$Username."\" AND AdminID != ".$admin.";";
	$res2 = mysqli_query($conn, $sql2);
	$row = mysqli_num_rows($res2);

	if ($row == 0) {
		$sqlt = "UPDATE admin SET Username = \"".$Username."\", Name = \"".$Name."\", PhoneNo = \"".$PhoneNo."\", Email = \"".$Email."\" WHERE AdminID = \"".$admin."\";";
      			...
      			<div>
      				...
      				<form class="modal-content animate" method="post">
      					...
      					<div class="container" style="text-align: left;">
      						...
      						<input type="text" value="<?php echo $myrow1['Username']; ?>" name="Username" required>

      						<label><b>Name</b></label>
      						<input type="text" value="<?php echo $myrow1['Name']; ?>" name="Name" required>

      						<label><b>Phone Number</b></label>
      						<input type="text" value="<?php echo $myrow1['PhoneNo']; ?>" name="PhoneNo" required>
      						
      						<label><b>Email</b></label>
      						<input type="text" value="<?php echo $myrow1['Email']; ?>" name="Email" required>

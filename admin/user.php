    	...
    	<div id="content" class="p-4 p-md-5 pt-5">
    		<div style="text-align: center; margin-top: 100px;">
      			<div class="flex-container">
	      			<a href="admin_list.php"><div class="flex-container2">Admin Account</div></a>
	      			<a href="teacher_list.php"><div class="flex-container2">Teacher Account</div></a>
	      			<a href="student_list.php"><div class="flex-container2">Student Account</div></a>
	      		</div>
	      	</div>
	    </div>
	</div>

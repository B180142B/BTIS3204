...
<?php
// Prepare a select statement
$sql1 = "SELECT * FROM class LEFT JOIN teacher ON class.TeacherID = teacher.TeacherID;";

$res1 = mysqli_query($conn, $sql1);

while ($myrow1 = mysqli_fetch_array($res1)) { ?>
						<tr>
							<td style="color: purple;"><?php echo $myrow1['Tingkatan'].$myrow1['ClassName']; ?></td>
							<?php
							if ($myrow1['ClassID']  != null) { ?>
							<td style="color: green;">Cik. <?php echo $myrow1['Name']; ?></td>
							<td><a href="assign_teacher.php?c=<?php echo $myrow1['ClassID']; ?>">Change Teacher</a></td>
<?php } else { ?>
							<td>-</td>
							<td><a href="assign_teacher.php?c=<?php echo $myrow1['ClassID']; ?>">Assign Teacher</a></td>
<?php }} ?>
						</tr>
      				</table>
      			</div>

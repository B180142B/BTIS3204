...
while ($myrow1 = mysqli_fetch_array($res1)) { ?>
						<tr>
							<td><a href="admin_account.php?a=<?php echo $myrow1['AdminID'] ?>"><?php echo $myrow1['Name']; ?></a></td>
						</tr>
<?php } ?>
      				</table>
      			</div>
      			<a href="new_admin.php" style="border: 2px solid; border-radius: 5px; padding: 5px; margin: 20px;">Add New Admin</a>
	      	</div>
	    </div>

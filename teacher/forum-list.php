...
$sql1 = "SELECT * FROM tpost LEFT JOIN teacher ON tpost.Teacher = teacher.TeacherID WHERE Showed = 1 ORDER BY `DateTime` DESC;";
...
$sql = "SELECT * FROM tpost LEFT JOIN teacher ON tpost.Teacher = teacher.TeacherID WHERE Showed = 1 ORDER BY `DateTime` DESC LIMIT ".$offset.", ".$pagesize.";";
$res = mysqli_query($conn, $sql);
while ($myrow = mysqli_fetch_array($res)){
?>
                                    <tr class="alert" role="alert">
                                        <td><a href="forum-comment.php?post=<?php echo $myrow['TPostID']; ?>" style="color: black;"><?php echo $myrow['TPost'];?></a></td>
